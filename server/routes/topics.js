...
import { requireContentOwner } from "../auth.js";
...
// requireContentOwner, not requireAuth — the GET routes above stay open, and
// quiz-taking in progress.js stays anonymous-friendly. See the middleware in
// auth.js for why editing no longer demands an account on a loopback install.
router.put("/:id/cards", requireContentOwner, (req, res) =>
...
router.put("/:id/flashcards", requireContentOwner, (req, res) =>
