// ─────────────────── cpp · 04.1 Function and Class Templates ───────────────────
// Content authored from Course staff's Data Structures lecture deck 04.1, "Function
// and Class Templates". Text is original; the code snippets are the deck's own.
export default {
  id: "templates",
  title: "Function & Class Templates",
  subtitle: "Data Structures — writing one version that works for every type",
  course: "cpp",
  showChart: false,
